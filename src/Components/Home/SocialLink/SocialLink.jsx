...
const SocialLink = () => {
    return (
        <div className="pb-10">
            <h1 className="font-extrabold text-5xl text-center p-5">Follow Me On</h1>
            <div className="lg:flex justify-center  gap-10 items-center">
                <div className="flex justify-between gap-5 p-5 rounded items-center bg-base-100 shadow-xl">
                    ...
                    <div className="">
                        <Link to="https://www.facebook.com/mansor.me777/" className="btn btn-outline btn-accent"><GoArrowRight /></Link>
                    </div>
                </div>
                <div className="flex justify-between gap-5 p-5 rounded items-center bg-base-100 shadow-xl">
                    ...
                    <div className="">
                        <Link to="https://www.instagram.com/mansor.me777/" className="btn btn-outline btn-accent"><GoArrowRight /></Link>
                    </div>
                </div>
            </div>
